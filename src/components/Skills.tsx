...
export const Skills = () => {
  ...
  return (
    <section id="experience" className="py-12 sm:py-16 px-4 sm:px-6 bg-white dark:bg-gray-900">
            ...
            return (
              <div key={index} className="card-modern border border-gray-200 dark:border-gray-800 rounded-2xl p-6 sm:p-8 hover:border-gray-300 dark:hover:border-gray-700 hover:shadow-[0_4px_20px_rgba(0,0,0,0.11)] dark:hover:shadow-[0_4px_20px_rgba(255,255,255,0.05)] hover:scale-[1.025] transition-all duration-300 ease-out bg-white dark:bg-gray-800">
                <div className="flex items-center gap-4 mb-6">
                  <div className="w-12 h-12 bg-gray-100 dark:bg-gray-700 rounded-xl flex items-center justify-center group-hover:bg-gray-200 dark:group-hover:bg-gray-600 transition-colors duration-300 ease-out">
                    <Icon className="w-6 h-6 text-gray-700 dark:text-gray-300 group-hover:scale-[1.05] transition-transform duration-300 ease-out" />
                  </div>
                ...
                <ul className="space-y-3">
                  {category.skills.map((skill, idx) => (
                    <li key={idx} className="text-gray-600 dark:text-gray-400 text-sm sm:text-base leading-relaxed pl-6 relative before:content-['•'] before:absolute before:left-0 before:text-gray-400 dark:before:text-gray-600 hover:text-gray-800 dark:hover:text-gray-300 hover:before:text-gray-600 dark:hover:before:text-gray-400 transition-colors duration-200 ease-out">
                      {skill}
                    </li>
                  ))}
                </ul>
